...
seo_description: "Conditions générales de vente des produits numériques de Stellaé Experiences."
---
...
Les présentes conditions s’appliquent à la vente des contenus numériques proposés sur ce site, notamment le programme « Le Socle », composé de guides au format PDF, d’enregistrements audio et d’un accès à un canal de discussion privé.

## Prix et paiement

Les prix sont indiqués en euros, toutes taxes comprises. Le paiement s’effectue en ligne par carte bancaire, par l’intermédiaire de Stripe. Aucune donnée bancaire n’est conservée par Stellaé Experiences.
...
**Stellaé Experiences accorde néanmoins une garantie commerciale de 14 jours.** Si le contenu ne correspond pas à ce qui était attendu, il suffit d’en faire la demande par courrier électronique dans les quatorze jours suivant l’achat pour obtenir le remboursement intégral.

## Propriété intellectuelle

Les contenus vendus sont réservés à un usage personnel. Leur reproduction, leur diffusion, leur revente ou leur partage, même partiels, sont interdits sans autorisation écrite préalable.

## Données personnelles

Les informations recueillies lors de l’achat servent uniquement au traitement de la commande et à l’envoi des accès. Voir la [politique de confidentialité](/politique-de-confidentialite/).
